...
Visualização em tempo real das câmeras públicas de Santos, consumindo endpoints HTTPS abertos, com análise de vídeo em OpenCV. [Versão web disponível](https://hericmr.github.io/cameras).
`Python` `OpenCV` `APIs`

### [Geosantos (O Caiçara)](https://github.com/hericmr/geosantos)
Jogo educativo de geolocalização em que o jogador identifica os bairros de Santos no mapa, resgatando referências culturais da região.
`TypeScript` `React`
